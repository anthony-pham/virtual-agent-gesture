...
<head type="NOD" amount=".3" start="myspeech:T8"/>')
...
<head type="NOD" amount=".3" start="myspeech:T18"/> \
<gaze direction="RIGHT" sbm:joint-range="HEAD CHEST" start="myspeech:T40" sbm:joint-speed="2000" target="ChrRachel"/> \
<gaze sbm:joint-range="HEAD CHEST" start="myspeech:T41" sbm:joint-speed="1500" target="ChrRachel"/>')
