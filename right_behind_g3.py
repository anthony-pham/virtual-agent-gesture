...
<gaze sbm:joint-range="HEAD CHEST" start="myspeech:T0" sbm:joint-speed="1500" target="ChrRachel"/> \
<gaze direction="RIGHT" sbm:joint-range="HEAD CHEST" start="myspeech:T12" sbm:joint-speed="1500" target="ChrRachel"/> \
<gesture name="ChrBrad@Idle01_IndicateRightRt01" stroke="myspeech:T12"/> \
<gaze sbm:joint-range="HEAD CHEST" start="myspeech:T18" sbm:joint-speed="1500" target="ChrRachel"/>')
...
<gesture name="ChrBrad@Idle01_ChopBoth01" stroke="myspeech:T2"/> \
<gesture name="ChrBrad@Idle01_ChopLf01" stroke="myspeech:T18"/>')
