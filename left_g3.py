...
<gesture name="ChrBrad@Idle01_PointLf01" stroke="myspeech:T6"/>')

bml.execBMLAt(3.5,'ChrRachel', '<speech type="application/ssml+xml" id="myspeech"> \
<mark name="T8"/>"Walk" \
<mark name="T9"/> \
<mark name="T10"/>"through" \
<mark name="T11"/> \
<mark name="T12"/>"the" \
<mark name="T13"/> \
<mark name="T14"/>"double" \
<mark name="T15"/> \
<mark name="T16"/>"doors" \
<mark name="T17"/> \
</speech> \
<gesture name="ChrBrad@Idle01_ChopBoth01" stroke="myspeech:T10"/> \
<gaze sbm:joint-range="HEAD CHEST" start="myspeech:T8" sbm:joint-speed="1500" target="ChrRachel"/>')
...
<mark name="T22"/>"the" \
<mark name="T23"/> \
<mark name="T24"/>"hallway" \
<mark name="T25"/> \
<mark name="T26"/>"and" \
<mark name="T27"/> \
<mark name="T28"/>"go" \
<mark name="T29"/> \
<mark name="T30"/>"through" \
<mark name="T31"/> \
<mark name="T32"/>"the" \
<mark name="T33"/> \
<mark name="T34"/>"door" \
...
<gesture name="ChrBrad@Idle01_ChopLf01" stroke="myspeech:T20"/> \
<gesture name="ChrBrad@Idle01_IndicateRightRt01" stroke="myspeech:T40"/>')

bml.execBMLAt(12,'ChrRachel', '<speech type="application/ssml+xml" id="myspeech"> \
<mark name="T42"/>"Follow" \
<mark name="T43"/> \
<mark name="T44"/>"the" \
<mark name="T45"/> \
<mark name="T46"/>"hallway" \
<mark name="T47"/> \
<mark name="T48"/>"and" \
<mark name="T49"/> \
<mark name="T50"/>"the" \
<mark name="T51"/> \
<mark name="T52"/>"location" \
<mark name="T53"/> \
<mark name="T54"/>"is" \
<mark name="T55"/> \
<mark name="T56"/>"straight" \
<mark name="T57"/> \
<mark name="T58"/>"ahead" \
<mark name="T59"/> \
</speech> \
<gaze sbm:joint-range="HEAD CHEST" start="myspeech:T56" target="ChrRachel"/> \
<gesture name="ChrBrad@Idle01_ChopLf01" stroke="myspeech:T56"/>')
...
## <gesture name="ChrBrad@Idle01_ChopLf01"/> #Go down the hallway/ straight
