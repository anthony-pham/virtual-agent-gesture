...
<head type="NOD" amount=".3" start="myspeech:T2"/>')
...
<gaze direction="RIGHT" sbm:joint-range="HEAD CHEST" start="myspeech:T10" sbm:joint-speed="2000" target="ChrRachel"/> \
<gaze sbm:joint-range="HEAD CHEST" start="myspeech:T11" sbm:joint-speed="1500" target="ChrRachel"/>')

bml.execBMLAt(10.5,'ChrRachel', '<speech type="application/ssml+xml" id="myspeech"> \
<mark name="T12"/>"turn" \
<mark name="T13"/> \
<mark name="T14"/>"slight" \
<mark name="T15"/> \
<mark name="T16"/>"left" \
<mark name="T17"/> \
<mark name="T18"/>"and" \
...
<gaze direction="LEFT" sbm:joint-range="EYES NECK" start="myspeech:T16" sbm:joint-speed="800" target="ChrRachel"/> \
<gaze sbm:joint-range="EYES NECK" start="myspeech:T22" sbm:joint-speed="800" target="ChrRachel"/> \
<gaze direction="RIGHT" sbm:joint-range="HEAD CHEST" start="myspeech:T32" sbm:joint-speed="2000" target="ChrRachel"/> \
<gaze sbm:joint-range="HEAD CHEST" start="myspeech:T33" sbm:joint-speed="1500" target="ChrRachel"/>')
