...
<gaze direction="LEFT" sbm:joint-range="HEAD CHEST" start="myspeech:T24" sbm:joint-speed="1500" target="ChrRachel"/> \
<gesture name="ChrBrad@Idle01_IndicateLeftLf01" stroke="myspeech:T24"/> \
<gesture name="ChrBrad@Idle01_PointLf01" stroke="myspeech:T40"/> \
