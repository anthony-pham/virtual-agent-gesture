...
<gesture name="ChrBrad@Idle01_PointRt01" stroke="myspeech:T10"/>')
...
<gaze sbm:joint-range="HEAD CHEST" start="myspeech:T12" sbm:joint-speed="1500" target="ChrRachel"/> \
<gesture name="ChrBrad@Idle01_IndicateLeftLf01" stroke="myspeech:T16"/> \
<gaze direction="RIGHT" sbm:joint-range="HEAD CHEST" start="myspeech:T32" sbm:joint-speed="1500" target="ChrRachel"/> \
<gesture name="ChrBrad@Idle01_IndicateRightRt01" stroke="myspeech:T32"/> \
